...
Its main purpose is to use better icons than the default ones.  As well as not being very pleasing the default ones display needlessly small and widely spaced; recent releases have made the window control icons tiny.  This version uses nicer ones displayed larger and closer together meaning they take up no extra space overall.
